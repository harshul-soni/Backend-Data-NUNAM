...
file_1 = combine_Excel_files(excel1) #function call to retrieve all the columns from the sheet DetailTemp_67_
parsed_file = parsed_file.append(file_1) #appending contents of file 1 to parsed_file

file_2 =combine_Excel_files(excel2) #function call to retrieve all the columns from the sheet DetailTemp_67_
...
parsed_file.to_csv(r'E:\NUNAM ASSIGN\detailTemp.csv') # converting to csv file
